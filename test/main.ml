...
(*let player_move_test (name : string) (position : Position.t) (roll : int)
  ...
  expected_output (Position.position_int (Player.move_to board roll))
  ~printer:string_of_int*)

(* make a few positions to test with:*)
let board0 = Position.get_initial
(*let board1 = Board.move_to Board.init 1 let board12 = Board.move_to Board.init
  12 let board21 = Board.move_to Board.init 21 let board35 = Board.move_to
  Board.init 35 let board37 = Board.move_to Board.init 37*)
...
(*let board_tests = [ (* don't move*) board_move_to_test "roll 0" Board.init 0
  ...
  board_move_to_test "roll 16 from 0" board0 16 16; board_move_to_test "roll
  15\n from 21" board21 15 36; (*move fowards pass one round*)
  board_move_to_test "roll 50" Board.init 50 10; board_move_to_test "roll 81"
  Board.init 81 1; board_move_to_test "roll 4 from 37" board37 4 1;
  board_move_to_test "roll 33\n from 21" board21 33 54; (*move fowards land on
  start*) board_move_to_test "roll 40" Board.init 40 0; board_move_to_test "roll
  19 from 21" board21 19 0; (*move backwards randomly*) board_move_to_test "roll
  -3" Board.init (-3) 37; board_move_to_test "roll -16 from 0" board0 (-16) 24;
  board_move_to_test "roll -15 from 21" board21 (-15) 6; board_move_to_test
  "roll -6 from 37" board37 (-6) 31; (*move backwards pass one round*)
  board_move_to_test "roll\n -50" Board.init (-50) 30; board_move_to_test "roll
  -81" Board.init (-81) 39; board_move_to_test "roll -14 from 12" board12 (-14)
  38; board_move_to_test "roll -33 from 21" board21 (-33) 28; (*move backwards
  land on 0*) board_move_to_test "roll -40" Board.init (-40) 0;
  board_move_to_test "roll\n -80 from 0" board0 (-80) 0; board_move_to_test
  "roll -12 from 12" board12 (-12) 12; ]*)
...
(* helper function to get the square from the index position *)
let get_square pos = Position.square_index board pos
